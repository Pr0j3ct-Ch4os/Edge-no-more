...
while (!($continue)) {
	Clear-Host; Write-Host "RicePot's Edge Removal tool.`n" -ForegroundColor Blue
    Write-Host "i worked on this since if u download microsoft edge, your stuck with it" -ForegroundColor Yellow
